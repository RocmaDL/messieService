    ...
    <div class="container mx-auto px-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div class="space-y-4">
          <h3 class="text-xl font-bold mb-4 flex items-center">
            <span class="bg-white text-blue-600 p-1 rounded mr-2">
              <svg
          ...
          <p class="text-gray-400 text-sm">
            Spécialiste du nettoyage professionnel pour particuliers et
            entreprises depuis 2010. Qualité et satisfaction client sont au cœur
            de notre engagement quotidien.
          </p>
        ...
        <div>
          ...
          <ul class="space-y-4">
            <li class="flex items-start">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-5 w-5 mr-3 text-blue-500 mt-1 flex-shrink-0"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
            ...
            <li>
              <a
                href="mailto:contact@messieservice.com"
                class="flex items-center text-gray-400 hover:text-white transition-colors"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="flex flex-col md:flex-row justify-between items-center">
        <p class="text-sm text-gray-500 mb-4 md:mb-0">
          &copy; {{ new Date().getFullYear() }} Messie Services. Tous droits
          réservés.
        </p>
